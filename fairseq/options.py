...
def parse_args_and_arch(
    ...
    parse_known: bool = True,
    suppress_defaults: bool = False,
    modify_parser: Optional[Callable[[configargparse.ArgumentParser], None]] = None,
):
    """
    Args:
    ...
    if suppress_defaults:
        ...
        suppressed_parser = configargparse.ArgumentParser(add_help=False, parents=[parser])
        suppressed_parser.set_defaults(**{k: None for k, v in vars(args).items()})
        args = suppressed_parser.parse_args(input_args)
        return configargparse.Namespace(
    ...
    usr_parser = configargparse.ArgumentParser(add_help=False, allow_abbrev=False)
...
def get_parser(desc, default_task="translation"):
    ...
    # usr_parser = configargparse.ArgumentParser(add_help=False, allow_abbrev=False)
    import configargparse
    usr_parser = configargparse.ArgumentParser(
