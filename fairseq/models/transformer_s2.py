    ...
    def forward_scriptable(
        ...
        for layer in self.layers:
            ...
            x = layer(
                ...
                s2=s2, s2_encoder_padding_mask=s2_encoder_padding_mask,
            )
            if return_all_hiddens:
        ...
        return {
            ...
            "s2_encoder_out": [s2],  # T x B x C
            "s2_encoder_padding_mask": [s2_encoder_padding_mask],  # B x T
    ...
    def extract_features_scriptable(
        ...
        for idx, layer in enumerate(self.layers):
            ...
            x, layer_attn, _ = layer(
                ...
                encoder_out_s2=encoder_out["s2_encoder_out"][0] if len(encoder_out["s2_encoder_out"]) > 0 else None,
                encoder_padding_mask_s2=encoder_out["s2_encoder_padding_mask"][0] if len(
